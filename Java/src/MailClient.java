...
public class MailClient {
    ...
    public void sendEmail(String senderEmail, String password, String recipients, String subject, String body,
            File attachment) {
        ...
        try {
         ...
         // RCPT TO for each recipient
            ...
            String emailContent = EmailWithAttachment.createEmailContent(senderEmail, recipients, subject, body, attachment);
     ...
     * String body = "Hello, this is a test email from Java using Naver SMTP."; //
     * 이메일 본문
     * 
