...
public class MailClient {
    ...
    public void sendEmail(String smtpId, String password, String senderEmail, String recipient, String subject, String body) {
    ...
    public static void main(String[] args) {
        ...
        mailClient.sendEmail(smtpId, password, senderEmail, recipient, subject, body);
    }
}
